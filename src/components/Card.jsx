...
const goToHome = (val)=>{
  ...
  return (
    <div className="card bg-base-100 w-[280px] sm:w-[250px]  shadow-[0px_0px_2px_black] px-1 ">
      <figure className="px-2 relative group pt-2 min-h-[360px] max-w-[360px]">
       {
          con?.poster_path ? <img
        ...
        <div className="shadow-[inset_-2px_-2px_4px_black,inset_2px_2px_4px_white] absolute h-[98%] rounded-xl px-2 py-1 backdrop-blur-2xl -bottom-100 w-[94%] mx-auto group-hover:bottom-0 transition-all duration-300 bg-black/50">
          <div className="w-full text-end">
            <button
              className="btn btn-circle w-fit h-fit relative p-1 top-2"
              onClick={() => handleHeart(con)}
            >
              {like ? (
          ...
          <div onClick={()=>goToHome(con.id)} className="text-[10px] text-white underline mt-1 text-end cursor-pointer">View More</div>
        </div>
      </figure>
